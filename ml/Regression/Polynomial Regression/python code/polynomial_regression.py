...
X = dataset.iloc[:, 1:2].values  # metrix IV
y = dataset.iloc[:, 2].values  # vector DV

"""
In this particular example ,
we simply do not have enough data ,
in order to split it between training & test
therefore we skip the set & training section
